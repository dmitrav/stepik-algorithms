...
def check_bs_tree_property(node, tree, mini, maxi):
    ...
    if node[1] < 0 and node[2] > 0:
        ...
        return check_bs_tree_property(tree[node[2]], tree, node[0] + 1, maxi)
        ...
        return check_bs_tree_property(tree[node[1]], tree, mini, node[0] - 1) and check_bs_tree_property(tree[node[2]], tree, node[0] + 1, maxi)
